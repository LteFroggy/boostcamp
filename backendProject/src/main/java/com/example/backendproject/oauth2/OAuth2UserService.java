...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    // 소셜 로그인 성공시에 사용자 정보를 구글 혹은 카카오에서 받아서 처리하는 함수
    @Override
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        System.out.println("✅ Kakao 로그인 요청 도착");
        ...
        System.out.println("▶ additionalParameters: " + userRequest.getAdditionalParameters());
